#Model: Phi-2 quantized model (4-bit QLoRA)
...
peft_training_args = TrainingArguments(
    ...
    learning_rate=5e-5,
    logging_steps=500,
    eval_steps=2000,#1000 is too much for evaluation, need to be adjusted to 5000
    save_steps=500,
    max_steps=30000,
    warmup_ratio=0.1,
...
peft_trainer.save_model("/scratch/dsu.local/khanh.nguyen/working/peft-phi-2-model-30k")
